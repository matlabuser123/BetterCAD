...
| Features | Fourteen. Extrude (to a depth, or through all of its target: [evidence](docs/verification/P12-FEAT-001/README.md)), revolve, sweep, loft (new body / join / cut / intersect); chamfer, fillet, hole (simple, counterbore, countersink; through, blind); linear pattern, circular pattern, mirror; split by a plane and combine bodies ([evidence](docs/verification/P12-FEAT-002/README.md)); shell, inward or outward, opened at named faces ([evidence](docs/verification/P12-FEAT-003/README.md)); draft of named faces about a neutral plane ([evidence](docs/verification/P12-FEAT-004/README.md)). |
