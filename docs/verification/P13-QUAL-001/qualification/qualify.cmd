@echo off
rem P13-QUAL-001 phase qualification: for each of the three presets,
...
rem times in Release and in Debug. A phase qualification repeats everything:
rem it has no reason to choose a subset.
rem
...
for %%P in (release debug) do (
    ...
    ctest --preset %%P -j 8 --repeat until-fail:5 > "%EVIDENCE%\ctest-repeat-%%P.log" 2>&1
